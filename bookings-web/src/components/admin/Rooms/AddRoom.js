...
const AddRoom = (props) => {
  ...
  const { name, location, capacity, time, number, images } = room;
  ...
  return (
    <div className='dashboard'>
      ...
      <div className='content-d'>
        ...
        <div
          className='add-room'
          style={{ paddingLeft: '50px', marginTop: '30px' }}
        >
          <div className='form1'>
            <Form>
              <FormGroup>
              ...
              <Row form>
                ...
                <Col md={6}>
                  <FormGroup>
                    <Label for='capacity' className='label'>
                      Capacity
                    </Label>
                    <Input
                      type='select'
              ...
              <FormGroup check inline>
                <label>
                  <input type='checkbox' name='Projector' onChange={onChange} />
                  <span>Projector </span>
                </label>
              </FormGroup>
              <FormGroup check inline>
              ...
              <FormGroup check inline>
                <label>
                  <input type='checkbox' name='Telephone' onChange={onChange} />
                  <span>Telephone</span>
                </label>
              </FormGroup>
              <Row>
